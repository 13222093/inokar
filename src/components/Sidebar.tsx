  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 bg-surface-container-low border-r border-outline-variant/15 flex flex-col py-8 z-[50]">
      <div className="px-6 mb-10">
        <h1 className="text-xl font-black text-primary font-headline tracking-tighter">AppraisIQ</h1>
      ...
      <div className="px-4 pt-6 border-t border-outline-variant/15 space-y-1">
        <ComingSoon label="Support — Coming Q2 2026" block>
          <div className="text-outline px-4 py-2 flex items-center gap-3 transition-all">
            <span className="material-symbols-outlined">help</span>
            <span className="font-headline font-semibold text-sm">Support</span>
          </div>
        </ComingSoon>
        <ComingSoon label="Auth & Logout — Coming Q2 2026" block>
          <div className="text-outline px-4 py-2 flex items-center gap-3 transition-all">
